...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description"> Sou um estudante de design e programação altamente criativo e apaixonado, 
            totalmente dedicado à minha área de especialização.</p>
